...
# Script d'automatisation OUSSA - Met à jour App.tsx et push sur GitHub
# Usage: bash update-oussa.sh

cd "C:\Users\HP\Documents\oussa-app-starter" || exit 1

echo "🔄 Démarrage de la mise à jour OUSSA..."
echo ""

# Créer un backup
echo "📦 Création du backup..."
cp src/App.tsx src/App.tsx.backup
echo "✅ Backup créé: src/App.tsx.backup"
echo ""

# Créer le nouveau fichier
echo "📝 Écriture du nouveau code..."
cat > src/App.tsx << 'EOF'
...
git commit -m "Redesign cartes posts: avatar + tags + image + description + likes cliquables"
...
echo "1. npm run dev"
echo "2. Visite http://192.168.x.x:5173 sur ton téléphone"
echo ""
